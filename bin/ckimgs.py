...
checks = {
    ...
    config.IMG_DIR_CODE_2:      None,
    config.IMG_DIR_COLL_43:     check_package,
    config.IMG_DIR_COLL_64:     check_package,
    config.IMG_DIR_ICON:        check_man,
    config.IMG_DIR_KING:        check_man,
    config.IMG_DIR_LESNEY:      check_set,
    config.IMG_DIR_LRW:         check_package,
    config.IMG_DIR_LSF:         check_package,
    config.IMG_DIR_MAN:         check_man,
    config.IMG_DIR_MATTEL:      check_package,
    config.IMG_DIR_MT_LAUREL:   check_package,
    config.IMG_DIR_PACK:        check_package,
    config.IMG_DIR_SERIES:      check_package,
    config.IMG_DIR_SKY:         None,
    config.IMG_DIR_TYCO:        check_package,
    config.IMG_DIR_UNIV:        check_package,
