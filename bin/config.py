...
IMG_DIR_PICS            = '/pic/misc'
IMG_DIR_PROD_CODE_2     = '/pic/prod/code2'
IMG_DIR_PROD_COLL_64    = '/pic/prod/prcoll'
...
IMG_DIR_PROD_PREMIUM    = '/pic/prod/premium'
IMG_DIR_PROD_PROMOS     = '/pic/prod/promo'
...
FLAG_LINK_LINE_RAW_HTML                 = 0x0200
