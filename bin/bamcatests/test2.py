...
class TestRender(unittest.TestCase):
    ...
    def test_print_html(self):
        self.pif.render.verbose = True
        self.assertIsNone(self.pif.render.comment('foo'))
        self.pif.render.verbose = False
    ...
    def test_error_report(self):
        self.assertOut(self.pif.render.error_report())

    def test_style_name1(self):
        self.assertOut(self.pif.render.style_name('name', 'eb'))

    def test_style_name2(self):
        self.assertOut(self.pif.render.style_name('name', 'eb', '1'))

    def test_style_name3(self):
        self.assertOut(self.pif.render.style_name('name', 'eb', id='foo'))

    def test_style_name4(self):
        self.assertOut(self.pif.render.style_name('name', 'eb', '1', id='foo'))
    ...
    def test_comment_dict(self):
        self.assertIsNone(self.pif.render.comment_dict('a', {1: 2}))
        self.pif.render.verbose = True
        self.assertIsNone(self.pif.render.comment_dict('a', {1: 2}))
        self.pif.render.verbose = False

    def test_format_head(self):
        self.assertOut(self.pif.render.format_head())
        self.pif.render.isbeta = True
        self.assertOut(self.pif.render.format_head())
        self.pif.render.isbeta = False

    def test_format_tail1(self):
        self.assertOut(self.pif.render.format_tail())
    ...
    def test_format_table_start(self):
        pass  # self.assertOut(self.pif.render.format_table_start(also={}, id='', style_id=''))

    def test_format_table_end(self):
        pass  # self.assertOut(self.pif.render.format_table_end())

    def test_format_row_start(self):
        pass  # self.assertOut(self.pif.render.format_row_start(ids=[], also={}))

    def test_format_row_end(self):
        pass  # self.assertOut(self.pif.render.format_row_end())

    def test_format_cell(self):
        pass  # self.assertOut(self.pif.render.format_cell(col=1, content="x", hdr=False, also={}, large=False, id=''))

    def test_format_cell_start(self):
        pass  # self.assertOut(self.pif.render.format_cell_start(col=None, hdr=False, also={}, large=False, id=''))
    ...
    def test_format_image_art(self):
        pass  # self.assertOut(self.pif.render.format_image_art('bamca', desc='', hspace=0, also={}))

    def test_format_image_flag(self):
        pass  # self.assertOut(self.pif.render.format_image_flag('SE', name='', hspace=0, also={}))
    ...
    def test_fmt_pseudo(self):
        ...
        self.assertOut(self.pif.render.fmt_pseudo('stuff <$art foo>'))
        self.assertOut(self.pif.render.fmt_pseudo('stuff <$button foo>'))

    def test_fmt_markup(self):
        pass  # self.assertOut(self.pif.render.fmt_markup('a', [{'b': 'c'}]))

    def test_fmt_art(self):
        self.assertOut(self.pif.render.fmt_art('bamca', desc='', prefix='', also={}))

    def test_fmt_img_src(self):
        self.assertOut(self.pif.render.fmt_img_src('pic/gfx/bamca.gif', alt=None, also={}))

    def test_fmt_img_check(self):
        pass  # self.assertOut(self.pif.render.fmt_img_check('foo'))
    ...
    def test_cookie_domain(self):
        pass  # self.assertOut(self.pif.render.secure.cookie_domain())

    def test_make_cookie(self):
        pass  # self.assertOut(self.pif.render.secure.make_cookie(id, privs, expires=6000))

    def test_get_cookies(self):
        self.assertOut(self.pif.render.secure.get_cookies())
